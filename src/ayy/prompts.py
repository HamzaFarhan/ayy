...
The function should always have just one parameter: `task: str`
...
Prefer to add _and_ to the name if it makes sense. For example to join multiple tools together.
...
In that case, just return empty strings like this: {"name": "", "signature": "", "docstring": ""}
...
Signature (generated by you):
    {
        ...
        "signature": "get_user_preferences_and_check_phone_availability_and_buy_phone(task: str)",
...
**Signature (generated by you):**
{
    ...
    "signature": "get_available_recipes_and_generate_shopping_list_and_plan_meals(task: str)",
...
**Signature (generated by you):**
{
    ...
    "signature": "get_expense_categories_and_record_expense_and_generate_expense_report(task: str)",
...
**Signature (generated by you):**
{
    ...
    "signature": "get_company_info_and_generate_questions_and_simulate_interview(task: str)",
