...
You have selected and used some tools to perform the task. If you had to encapsulate this whole flow in a single tool call, what would the function signature look like? With a verbose name and detailed docstring? In a JSON format.
...
Signature (generated by you):
    {
        ...
        "signature": "get_user_preferences_and_buy_phone(task: str)",
...
**Signature (generated by you):**
{
    ...
    "signature": "organize_weekly_meals(task: str)",
...
**Signature (generated by you):**
{
    ...
    "signature": "track_daily_expenses(task: str)",
...
**Signature (generated by you):**
{
    ...
    "signature": "prepare_for_job_interview(task: str)",
