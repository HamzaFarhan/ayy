...
The main purpose of summarization is to condense lengthy conversations into a brief, digestible format. Your summary should be much shorter than the original conversation - aim to capture key points and outcomes rather than listing every exchange.
...
2. Core information that should be remembered long-term, such as:
...
3. Temporary information relevant to ongoing tasks:
...
Format your response as a structured Summary object with bullet_points, core_information, and temporary_information fields.
"""
